...
- practicalone/DisplayArtwork.java:
  ...
  - Produces exactly one of the `@@` output fragment in the terminal
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2018/cs100-F2018-practical1-starter.git
```
...
you can go to the [Computer Science 100 Practical 1
Starter](https://github.com/Allegheny-Computer-Science-100-F2018/cs100-F2018-practical1-starter)
